...
wget "http://www.ftp.ncep.noaa.gov/data/nccf/com/gfs/prod/gfs."$yh"00/gfs.t00z.pgrb2f180.idx" -O gfs_when
size=`wc -c <gfs_when`;
ls -la gfs_when
...
wget "http://www.ftp.ncep.noaa.gov/data/nccf/com/gfs/prod/gfs."$yt"00/gfs.t00z.pgrb2f180.idx" -O gfs_when
size=`wc -c <gfs_when`;
ls -la gfs_when
#if test "$size" -gt "10"; then
	t="00";
