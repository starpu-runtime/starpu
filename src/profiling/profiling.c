...
int _starpu_codelet_profiling = 1;
int _starpu_energy_profiling = 0;
...
void _starpu_profiling_start(void)
{
	...
	_starpu_codelet_profiling = starpu_get_env_number_default("STARPU_CODELET_PROFILING", 1);
	_starpu_energy_profiling = starpu_get_env_number_default("STARPU_ENERGY_PROFILING", 0);
}
