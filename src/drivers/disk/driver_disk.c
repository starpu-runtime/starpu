 ...
 *
 * Copyright (C) 2013-2024  University of Bordeaux, CNRS (LaBRI UMR 5800), Inria
...
static uintptr_t _starpu_disk_malloc_on_device(int dst_dev, size_t size, int flags)
{
	(void) flags;
	uintptr_t addr = 0;
...
static void _starpu_disk_free_on_device(int dst_dev, uintptr_t addr, size_t size, int flags)
{
	(void) flags;
	_starpu_disk_free(dst_dev, (void *) addr , size);
}

static int _starpu_disk_copy_src_to_disk(void * src, int src_dev, void * dst, size_t dst_offset, int dst_dev, size_t size, void * async_channel)
{
	return _starpu_disk_write(src_dev, dst_dev, dst, src, dst_offset, size, async_channel);
}

static int _starpu_disk_copy_disk_to_src(void * src, size_t src_offset, int src_dev, void * dst, int dst_dev, size_t size, void * async_channel)
{
	return _starpu_disk_read(src_dev, dst_dev, src, dst, src_offset, size, async_channel);
}

static int _starpu_disk_copy_disk_to_disk(void * src, size_t src_offset, int src_dev, void * dst, size_t dst_offset, int dst_dev, size_t size, void * async_channel)
{
...
static int _starpu_disk_copy_data_from_disk_to_cpu(uintptr_t src, size_t src_offset, int src_dev, uintptr_t dst, size_t dst_offset, int dst_dev, size_t size, struct _starpu_async_channel *async_channel)
{
...
static int _starpu_disk_copy_data_from_disk_to_disk(uintptr_t src, size_t src_offset, int src_dev, uintptr_t dst, size_t dst_offset, int dst_dev, size_t size, struct _starpu_async_channel *async_channel)
{
...
static int _starpu_disk_copy_data_from_cpu_to_disk(uintptr_t src, size_t src_offset, int src_dev, uintptr_t dst, size_t dst_offset, int dst_dev, size_t size, struct _starpu_async_channel *async_channel)
{
