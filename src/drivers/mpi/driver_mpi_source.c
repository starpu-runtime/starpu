...
uintptr_t _starpu_driver_mpi_allocate(int devid, size_t size, int flags)
{
	return _starpu_src_common_allocate(STARPU_MPI_MS_WORKER, devid, size, flags);
}

void _starpu_driver_mpi_free(int devid, uintptr_t addr, size_t size, int flags)
{
...
int _starpu_driver_mpi_copy_data_host_to_sink(uintptr_t src, size_t src_offset, int src_devid, uintptr_t dst, size_t dst_offset, int dst_devid, size_t size, struct _starpu_async_channel *async_channel)
{
...
int _starpu_driver_mpi_copy_data_sink_to_host(uintptr_t src, size_t src_offset, int src_devid, uintptr_t dst, size_t dst_offset, int dst_devid, size_t size, struct _starpu_async_channel *async_channel)
{
...
int _starpu_driver_mpi_copy_data_sink_to_sink(uintptr_t src, size_t src_offset, int src_devid, uintptr_t dst, size_t dst_offset, int dst_devid, size_t size, struct _starpu_async_channel *async_channel)
{
