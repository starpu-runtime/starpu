 ...
 * - A is read by P2 without P0 knowing
 * - source of A for P2 is reset to P0
 * - A is read on P2
 * This test asserts that P2 either receives the value frmo P0 as resetting the
 * alternative source reset the cache OR P1 sent its cache state to P0 and P2 prints
 * the value it received from P1.
 */
