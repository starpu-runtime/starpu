...
struct _starpu_mpi_backend
{
	...
	/* Optional functions for early memory registration on sender-side. The
	 * second one cancels the first one in case the memory registration was
	 * done on a wrong node. They are typically called during the
