...
realFiles = [f for f in files if os.path.isfile(f) and f.find("png") == -1 and f.find("gz") == -1 and f.find("wav") == -1 and f.find("./examples/pi/SobolQRNG/CforCUDA_SDK_license.txt")==-1 and f.find(".git")==-1  and f.find("Makefile.in")==-1 and f.find("min-dgels")==-1 and f.find("old_examples")==-1]
