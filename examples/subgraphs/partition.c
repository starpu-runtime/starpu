...
void do_init_sub_data(STARPU_ATTRIBUTE_UNUSED int matrix[NX][NY], STARPU_ATTRIBUTE_UNUSED starpu_data_handle_t handle, STARPU_ATTRIBUTE_UNUSED starpu_data_handle_t sub_handle[PARTS],
...
int do_apply_sub_graph(starpu_data_handle_t handle, STARPU_ATTRIBUTE_UNUSED starpu_data_handle_t sub_handle[PARTS], void (*filter_func)(void *parent_interface, void *child_interface, struct starpu_data_filter *, unsigned id, unsigned nparts), int factor, int start)
{
	int i, ret;
...
int do_clean_sub_graph(STARPU_ATTRIBUTE_UNUSED starpu_data_handle_t handle, STARPU_ATTRIBUTE_UNUSED starpu_data_handle_t sub_handle[PARTS])
{
	// nothing to do
	return 0;
}
