...
STARPUFFT(fft1_2d_kernel_gpu)(starpu_data_interface_t *descr, void *_args)
{
	...
	const _cufftComplex *roots0 = (_cufftComplex *)descr[2].vector.ptr;
	const _cufftComplex *roots1 = (_cufftComplex *)descr[3].vector.ptr;
...
STARPUFFT(fft1_2d_kernel_cpu)(starpu_data_interface_t *descr, void *_args)
{
	...
	_fftw_complex *worker_in1 = (STARPUFFT(complex) *)plan->plans[workerid].in1;
	_fftw_complex *worker_out1 = (STARPUFFT(complex) *)plan->plans[workerid].out1;
...
STARPUFFT(twist2_2d_kernel_cpu)(starpu_data_interface_t *descr, void *_args)
{
	...
	STARPUFFT(complex) *twisted2 = (STARPUFFT(complex) *)descr[0].vector.ptr;
...
STARPUFFT(fft2_2d_kernel_cpu)(starpu_data_interface_t *descr, void *_args)
{
	...
	_fftw_complex *worker_in2 = (STARPUFFT(complex) *)plan->plans[workerid].in2;
	_fftw_complex *worker_out2 = (STARPUFFT(complex) *)plan->plans[workerid].out2;
...
STARPUFFT(twist3_2d_kernel_cpu)(starpu_data_interface_t *descr, void *_args)
{
	...
	const STARPUFFT(complex) *fft2 = (STARPUFFT(complex) *)descr[0].vector.ptr;
...
static starpu_codelet STARPUFFT(fft1_2d_codelet) = {
	.where =
		...
		0,
#ifdef USE_CUDA
	.cublas_func = STARPUFFT(fft1_2d_kernel_gpu),
#endif
#ifdef HAVE_FFTW
...
static starpu_codelet STARPUFFT(fft2_2d_codelet) = {
	.where =
		...
		0,
#ifdef USE_CUDA
	.cublas_func = STARPUFFT(fft2_2d_kernel_gpu),
#endif
#ifdef HAVE_FFTW
...
#undef STEP_TAG
	...
	task->cl = &STARPUFFT(void_codelet);
