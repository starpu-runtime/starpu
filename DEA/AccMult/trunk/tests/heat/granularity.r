...
display_grain <- function()
{
	...
	colarray <- c("blue", "peru", "green3", "red", "black", "orange");
	...
	axis(1, at=seq(0, max*1024, 1024))
	axis(2, at=seq(0, 100, 10), tck=1)
#	axis(4, at=seq(0, 100, 10))
	box(bty="u")

	labels <- c("128", "256", "512", "1024", "1536", "2048");
