...
# Compilation profiles
    ...
    { 'name'        : 'tcpip-ms',
      'deploy'      : True,
      'opts'        : ['--enable-tcpip-server-client', '--disable-socl', '--disable-cpu', '--disable-cuda', '--disable-hip', '--disable-opencl', '--disable-mpi-check'],
      'hosts'       : ['node_nogpu'],
      'env'         : {'STARPU_MICROBENCHS_DISABLED' : '1'},
    },
    ...
    { 'name'        : 'hwloc3',
      'deploy'      : True,
      'hwloc_input' : None,
      'env'         : { 'PKG_CONFIG_PATH' : '/usr/local/stow/hwloc-3.0.0a1/lib/pkgconfig'},
      'hosts'       : ['node_gpu']
    },
    { 'name'        : 'memory-stats',
    ...
    { 'name'        : 'starpupy-multi-interp',
      'env'         : { 'STARPUPY_MULTI_INTERPRETER' : '1', 'PYTHON' : 'python3.11' },
      'deploy'      : True,
      'hosts'       : ['node_gpu'],
      'rcheck'      : ['-C', 'starpupy']
