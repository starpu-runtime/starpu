...
#define STARPU_TASK_INITIALIZER                                                      \
	{                                                                            \
		...
		.cl_ret			                   = NULL,                   \
		.cl_ret_size		                   = 0,                      \
		.soon_callback_func		           = NULL,                   \
		.soon_callback_arg		           = NULL,                   \
		.prologue_callback_func		           = NULL,                   \
		.prologue_callback_arg		           = NULL,                   \
		.prologue_callback_pop_func	           = NULL,                   \
		.prologue_callback_pop_arg	           = NULL,                   \
		...
		.cl_arg_free                               = 0,                      \
		.cl_ret_free                               = 0,                      \
		.soon_callback_arg_free                    = 0,                      \
		.prologue_callback_arg_free                = 0,                      \
		.prologue_callback_pop_arg_free            = 0,                      \
		.epilogue_callback_arg_free                = 0,                      \
		.callback_arg_free                         = 0,                      \
		.use_tag		                   = 0,                      \
		...
		.starpu_private		                   = NULL,                   \
		.omp_task                                  = NULL,                   \
		.recursive_task_is_sync_task               = 0,                      \
		.recursive_task_parent                     = 0,                      \
		.recursive_task_func                       = 0,                      \
		.recursive_task_func_arg                   = NULL,                   \
		.recursive_task_gen_dag_func               = 0,                      \
		.recursive_task_gen_dag_func_arg           = NULL,                   \
		.recursive_task_communication_already_made = 0,                      \
		.sched_data                                = NULL,                   \
		.magic			                   = 42,                     \
		.type			                   = 0,                      \
		.scheduled		                   = 0,                      \
