...
/**
   Used when calling starpu_task_insert(), must be followed by an array of
   ints representing each handle's specific node and the number of elements
   in the array (as int).
   This is equivalent to passing the handles with the corresponding modes.
*/
...
*/
#define STARPU_TAG (11 << STARPU_MODE_SHIFT)

/**
   Used when calling starpu_task_insert(), must be followed by a tag.
*/
#define STARPU_HYPERVISOR_TAG (12 << STARPU_MODE_SHIFT)
...
/**
   ...
   function
*/
#define STARPU_PROLOGUE_CALLBACK_ARG (16 << STARPU_MODE_SHIFT)

/**
   Used when calling starpu_task_insert(), must be followed by a
   pointer to a prologue callback pop function
*/
#define STARPU_PROLOGUE_CALLBACK_POP (17 << STARPU_MODE_SHIFT)
...
/**
   ...
   function
*/
#define STARPU_PROLOGUE_CALLBACK_POP_ARG (18 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_EXECUTE_ON_WORKER (19 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_WORKER_ORDER (23 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_NODE_SELECTION_POLICY (24 << STARPU_MODE_SHIFT)

/**
   Used when calling starpu_task_insert(), must be followed by a
   char * stored in starpu_task::name.
*/
#define STARPU_NAME (25 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_CL_ARGS (26 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_CL_ARGS_NFREE (27 << STARPU_MODE_SHIFT)
...
/**
   ...
   given values.
*/
#define STARPU_TASK_DEPS_ARRAY (28 << STARPU_MODE_SHIFT)

/**
   Used when calling starpu_task_insert(), must be followed by an
   integer representing a color
*/
#define STARPU_TASK_COLOR (29 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_HANDLES_SEQUENTIAL_CONSISTENCY (30 << STARPU_MODE_SHIFT)

/**
   Used when calling starpu_task_insert(), must be followed by an
   integer stating if the task is synchronous or not
*/
#define STARPU_TASK_SYNCHRONOUS (31 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_TASK_END_DEP (33 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_TASK_WORKERIDS (34 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_SEQUENTIAL_CONSISTENCY (35 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_CALLBACK_ARG_NFREE (38 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_CALLBACK_WITH_ARG_NFREE (39 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_PROLOGUE_CALLBACK_ARG_NFREE (40 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_PROLOGUE_CALLBACK_POP_ARG_NFREE (41 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_TASK_FILE (44 << STARPU_MODE_SHIFT)
...
/**
   ...
   This is automatically set when FXT is enabled.
*/
#define STARPU_TASK_LINE (45 << STARPU_MODE_SHIFT)

/**
   Used when calling starpu_task_insert(), must be followed by a
   pointer to a epilogue callback function
*/
#define STARPU_EPILOGUE_CALLBACK (46 << STARPU_MODE_SHIFT)
...
/**
   ...
   function
*/
#define STARPU_EPILOGUE_CALLBACK_ARG (47 << STARPU_MODE_SHIFT)
...
*/
#define STARPU_RECURSIVE_TASK_FUNC (48 << STARPU_MODE_SHIFT)
...
/**
   ...
   See \ref RecursiveTasks for more details.
*/
#define STARPU_RECURSIVE_TASK_FUNC_ARG (49 << STARPU_MODE_SHIFT)
...
/**
   ...
   See \ref RecursiveTasks for more details.
*/
#define STARPU_RECURSIVE_TASK_GEN_DAG_FUNC (50 << STARPU_MODE_SHIFT)
...
/**
   ...
   See \ref RecursiveTasks for more details.
*/
#define STARPU_RECURSIVE_TASK_GEN_DAG_FUNC_ARG (51 << STARPU_MODE_SHIFT)
...
/**
   ...
   See \ref RecursiveTasks for more details.
*/
#define STARPU_RECURSIVE_TASK_PARENT (52 << STARPU_MODE_SHIFT)
...
/**
   ...
   See \ref RecursiveTasks for more details.
*/
#define STARPU_RECURSIVE_TASK_NO_PRUNE (53 << STARPU_MODE_SHIFT)
