...
#ifndef __STARPU_SCHEDULERS_HPBASIC_H__
#define __STARPU_SCHEDULERS_HPBASIC_H__
...
*/
#define STARPU_HPBASIC_MAXTYPESOFTASKS 100
...
#endif /* __STARPU_SCHEDULERS_HPBASIC_H__ */
