...
static int
s_start_jvm (JavaVM **p_jvm, JNIEnv **p_env, const char *jarfile);
static int
s_terminate_jvm (JavaVM *jvm);
static int
s_invoke_main_from_class (JavaVM *jvm, JNIEnv *env, const char *classname,
                          int argc, char **argv);
...
static jobjectArray
s_argv_to_array (JNIEnv *env, int argc, char **argv)
{
...
static char *
s_build_classpath (const char *jarfile)
{
