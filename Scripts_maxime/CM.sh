...
echo "CM"
STARPU_SCHED=cuthillmckee STARPU_LIMIT_BANDWIDTH=350 PRINTF=0 STARPU_LIMIT_CUDA_MEM=500 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/mult/sgemm -xy $((960*5)) -nblocks 5 -iter 1
#~ echo "HFP"
