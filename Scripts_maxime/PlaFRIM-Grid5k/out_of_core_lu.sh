# bash Scripts_maxime/PlaFRIM-Grid5k/out_of_core_lu.sh 320 12 5 1000 modular-eager-prefetching
# bash Scripts_maxime/PlaFRIM-Grid5k/out_of_core_lu.sh 320 12 5 1000 dmdas
# bash Scripts_maxime/PlaFRIM-Grid5k/out_of_core_lu.sh 320 12 5 1000 dmdar
# bash Scripts_maxime/PlaFRIM-Grid5k/out_of_core_lu.sh 320 12 5 1000 lws
# bash Scripts_maxime/PlaFRIM-Grid5k/out_of_core_lu.sh 320 12 5 1000 dynamic-data-aware
# oarsub -p nova -l walltime=06:00:00 "bash Scripts_maxime/PlaFRIM-Grid5k/out_of_core_lu.sh 320 12 5 1000 dynamic-data-aware"
...
echo ${CM}"Mo -" ${TAILLE_TUILE} "tiles -" ${ECHELLE_X} "echelle -" ${NB_TAILLE_TESTE} "tailles testées -" ${SCHEDULER}
	
FICHIER_RAW=Output_maxime/Data/Out_of_core_lu/GF_${TAILLE_TUILE}_${CM}Mo_${SCHEDULER}.txt
FICHIER_RAW_DT=Output_maxime/Data/Out_of_core_lu/DT_${TAILLE_TUILE}_${CM}Mo_${SCHEDULER}.txt
FICHIER_BUS=Output_maxime/Data/Out_of_core_lu/BUS_${TAILLE_TUILE}_${CM}Mo_${SCHEDULER}.txt
