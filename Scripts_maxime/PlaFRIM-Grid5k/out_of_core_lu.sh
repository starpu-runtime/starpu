...
FICHIER_RAW_DT=Output_maxime/out_of_core_raw_dt.txt
...
mv Output_maxime/out_of_core_raw.txt Output_maxime/Data/Out_of_core_lu/GF_${TAILLE_TUILE}_${CM}Mo_${SCHEDULER}.txt
mv Output_maxime/out_of_core_raw_dt.txt Output_maxime/Data/Out_of_core_lu/DT_${TAILLE_TUILE}_${CM}Mo_${SCHEDULER}.txt
