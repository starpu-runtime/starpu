# bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_Mutex_DARTS.sh 8 Matrice_ligne mutex_darts 4
...
then
	...
	FICHIER_CONFLITS=Nb_conflit_donnee_mutex_M2D_${NGPU}GPU.txt
	...
	FICHIER_CONFLITS_LINEAR=Nb_conflit_donnee_linear_mutex_M2D_${NGPU}GPU.txt
fi
...
then
	...
	FICHIER_CONFLITS=Nb_conflit_donnee_mutex_M3D_${NGPU}GPU.txt
	...
	FICHIER_CONFLITS_LINEAR=Nb_conflit_donnee_linear_mutex_M3D_${NGPU}GPU.txt
fi
if [ $DOSSIER == "Cholesky" ]
then
	NB_ALGO_TESTE=6
	...
	FICHIER_CONFLITS=Nb_conflit_donnee_mutex_CHO_${NGPU}GPU.txt
	...
	FICHIER_CONFLITS_LINEAR=Nb_conflit_donnee_linear_mutex_CHO_${NGPU}GPU.txt
fi
