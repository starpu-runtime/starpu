...
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_IPDPS.sh 15 Matrice_ligne dynamic_data_aware_no_hfp 2 7 S
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_IPDPS.sh 10 Matrice_ligne dynamic_data_aware_no_hfp 3 6 X
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_IPDPS.sh 10 Matrice_ligne dynamic_data_aware_no_hfp 4 6 X
