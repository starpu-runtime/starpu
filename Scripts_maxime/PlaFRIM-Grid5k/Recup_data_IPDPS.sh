...
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_IPDPS.sh 15 Matrice_ligne dynamic_data_aware_no_hfp 1 5 X
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_IPDPS.sh 15 Matrice_ligne dynamic_data_aware_no_hfp 2 6 V
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Recup_data_IPDPS.sh 10 Matrice_ligne dynamic_data_aware_no_hfp 3 6 X
...
if [ $MODEL == "dynamic_data_aware_no_hfp" ]
	...
	Rscript ${PATH_R}/R/ScriptR/GF_X.R ${PATH_R}/R/Data/PlaFRIM-Grid5k/${DOSSIER}/DT_${MODEL}_${GPU}_${NGPU}GPU.txt DT_${MODEL}_ipdps ${DOSSIER} ${GPU} ${NGPU}
