...
# Matrice 2D SPARSE
MODEL=dynamic_data_aware_no_hfp_sparse_matrix
...
NB_TAILLE_TESTE=10
NB_ALGO_TESTE=8
scp mgonthier@access.grid5000.fr:/home/mgonthier/lyon/starpu/Output_maxime/GF_HFP_M2D_SPARSE_${NGPU}GPU.txt /home/gonthier/starpu/Output_maxime/Data/${DOSSIER}/GFlops_raw_out_1.txt
scp mgonthier@access.grid5000.fr:/home/mgonthier/lyon/starpu/Output_maxime/DT_HFP_M2D_SPARSE_${NGPU}GPU.txt /home/gonthier/starpu/Output_maxime/Data/${DOSSIER}/GFlops_raw_out_3.txt
...
NB_TAILLE_TESTE=10
NB_ALGO_TESTE=11
scp mgonthier@access.grid5000.fr:/home/mgonthier/lyon/starpu/Output_maxime/GF_HFP_M3D_SPARSE_${NGPU}GPU.txt /home/gonthier/starpu/Output_maxime/Data/${DOSSIER}/GFlops_raw_out_1.txt
scp mgonthier@access.grid5000.fr:/home/mgonthier/lyon/starpu/Output_maxime/DT_HFP_M3D_SPARSE_${NGPU}GPU.txt /home/gonthier/starpu/Output_maxime/Data/${DOSSIER}/GFlops_raw_out_3.txt
gcc -o cut_gflops_raw_out cut_gflops_raw_out.c
./cut_gflops_raw_out $NB_TAILLE_TESTE $NB_ALGO_TESTE $ECHELLE_X $START_X /home/gonthier/starpu/Output_maxime/Data/${DOSSIER}/GFlops_raw_out_1.txt ${PATH_R}/R/Data/PlaFRIM-Grid5k/${DOSSIER}/GF_${MODEL}_${GPU}_${NGPU}GPU.txt
Rscript ${PATH_R}/R/ScriptR/GF_X.R ${PATH_R}/R/Data/PlaFRIM-Grid5k/${DOSSIER}/GF_${MODEL}_${GPU}_${NGPU}GPU.txt ${MODEL} ${DOSSIER} ${GPU} ${NGPU} ${NITER}
mv ${PATH_STARPU}/starpu/Rplots.pdf ${PATH_R}/R/Courbes/PlaFRIM-Grid5k/${DOSSIER}/GF_${MODEL}_${GPU}_${NGPU}GPU.pdf
