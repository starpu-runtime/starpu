...
#~ bash Scripts_maxime/PlaFRIM-Grid5k/lu.sh 2 1920 12 0 best_ones
#~ bash Scripts_maxime/PlaFRIM-Grid5k/lu.sh 4 1920 12 0 best_ones
#~ bash Scripts_maxime/PlaFRIM-Grid5k/lu.sh 8 1920 12 0 best_ones
