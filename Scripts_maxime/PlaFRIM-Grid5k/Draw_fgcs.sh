...
if [ $DOSSIER == "Matrice_ligne" ] && [ $MODEL == "HFP" ]
	...
	scp ${NAME}@access.grid5000.fr:/home/${NAME}/lyon/starpu/Output_maxime/GF_HFP_M2D.txt ${PATH_STARPU}/starpu/Output_maxime/Data/${DOSSIER}/GF_HFP_M2D.txt
	scp ${NAME}@access.grid5000.fr:/home/${NAME}/lyon/starpu/Output_maxime/DT_HFP_M2D.txt ${PATH_STARPU}/starpu/Output_maxime/Data/${DOSSIER}/DT_HFP_M2D.txt
