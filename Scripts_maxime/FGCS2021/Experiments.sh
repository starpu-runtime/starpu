...
#~ bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 10 Matrice_ligne HFP_memory 1 		 V
...
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 8 Sparse HFP 1								V
...
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 8 Sparse HFP_mem_infinie 1					V
