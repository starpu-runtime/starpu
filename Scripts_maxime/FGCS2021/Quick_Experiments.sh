...
make -j 100
make install
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 10 Matrice_ligne HFP 1
...
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 5 Matrice3DZN HFP 1
...
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 5 Cholesky HFP 1
...
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 10 Random_task_order HFP 1
...
bash Scripts_maxime/PlaFRIM-Grid5k/FGCS.sh 10 Random_tasks HFP 1
