...
bash Scripts_maxime/PlaFRIM-Grid5k/Draw_fgcs.sh 2 Matrice_ligne HFP_memory 1 10 ${NAME} ${PATH_STARPU} ${PATH_R}
#~ bash Scripts_maxime/PlaFRIM-Grid5k/Draw_fgcs.sh 6 Matrice3D HFP 1 10 ${NAME} ${PATH_STARPU} ${PATH_R}
bash Scripts_maxime/PlaFRIM-Grid5k/Draw_fgcs.sh 2 Matrice3DZN HFP 1 9 ${NAME} ${PATH_STARPU} ${PATH_R}
