...
#~ STARPU_SCHED=HFP ORDER_U=0 PRINTF=1 BELADY=0 STARPU_NTASKS_THRESHOLD=30 STARPU_CUDA_PIPELINE=4 STARPU_LIMIT_BANDWIDTH=350 STARPU_LIMIT_CUDA_MEM=500 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/cholesky/cholesky_implicit -size $((960*15)) -nblocks $((15))

#~ i=15 ;  STARPU_SCHED=HFP PRINTF=1 RANDOM_DATA_ACCESS=1 STARPU_TASK_PROGRESS=0 BELADY=0 ORDER_U=0 STARPU_NTASKS_THRESHOLD=30 STARPU_LIMIT_BANDWIDTH=350 STARPU_LIMIT_CUDA_MEM=500 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/mult/sgemm -xy $((960*$i)) -nblocks $i -iter 1

i=15 ; STARPU_SCHED=HFP PRINTF=1 STARPU_TASK_PROGRESS=1 BELADY=1 ORDER_U=0 STARPU_NTASKS_THRESHOLD=30 STARPU_LIMIT_BANDWIDTH=350 STARPU_LIMIT_CUDA_MEM=50 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/mult/sgemm -3d -xy $((960*i)) -nblocks $((i)) -nblocksz 4 -iter 1
