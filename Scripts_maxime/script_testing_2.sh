...
i=15 ; STARPU_SCHED=HFP PRINTF=0 STARPU_TASK_PROGRESS=1 STARPU_GENERATE_TRACE=0 STARPU_SIMGRID_CUDA_MALLOC_COST=0 BELADY=1 ORDER_U=1 STARPU_NTASKS_THRESHOLD=30 STARPU_CUDA_PIPELINE=4 STARPU_LIMIT_BANDWIDTH=350 STARPU_LIMIT_CUDA_MEM=350 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/mult/sgemm -xy $((960*$i)) -nblocks $i -iter 1
