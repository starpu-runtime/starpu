...
#~ STARPU_SCHED=HFP ORDER_U=1 BELADY=1 ./examples/mult/sgemm -xy $((960*5)) -nblocks $((5)) -iter 1

A ajouter! STARPU_TRACE_BUFFER_SIZE

STARPU_GENERATE_TRACE=1 STARPU_SCHED=HFP ORDER_U=1 STARPU_NTASK_THRESHOLD=30 STARPU_CUDA_PIPELINE=4 STARPU_LIMIT_CUDA_MEM=500 STARPU_MINIMUM_CLEAN_BUFFERS=0 STARPU_TARGET_CLEAN_BUFFERS=0 STARPU_NCUDA=1 STARPU_NCPU=0 STARPU_NOPENCL=0 ./examples/mult/sgemm -xy $((960*10)) -nblocks 10 -iter 11

STARPU_GENERATE_TRACE=1 STARPU_SCHED=dmdar STARPU_CUDA_PIPELINE=4 STARPU_LIMIT_CUDA_MEM=500 STARPU_MINIMUM_CLEAN_BUFFERS=0 STARPU_TARGET_CLEAN_BUFFERS=0 STARPU_NCUDA=1 STARPU_NCPU=0 STARPU_NOPENCL=0 ./examples/mult/sgemm -xy $((960*40)) -nblocks 40 -iter 11

STARPU_GENERATE_TRACE=1 STARPU_SCHED=eager STARPU_CUDA_PIPELINE=4 STARPU_LIMIT_CUDA_MEM=500 STARPU_MINIMUM_CLEAN_BUFFERS=0 STARPU_TARGET_CLEAN_BUFFERS=0 STARPU_NCUDA=1 STARPU_NCPU=0 STARPU_NOPENCL=0 ./examples/mult/sgemm -xy $((960*30)) -nblocks 30 -iter 11
