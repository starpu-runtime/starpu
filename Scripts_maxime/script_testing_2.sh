...
#~ i=15 ; STARPU_SCHED=HFP ORDER_U=1 PRINTF=2 STARPU_TASK_PROGRESS=1 BELADY=1 STARPU_NTASKS_THRESHOLD=30 STARPU_CUDA_PIPELINE=4 STARPU_LIMIT_BANDWIDTH=350 STARPU_GENERATE_TRACE=1 STARPU_LIMIT_CUDA_MEM=500 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/cholesky/cholesky_implicit -size $((960*i)) -nblocks $((i))

i=15 ; STARPU_SCHED=dmdar STARPU_TASK_PROGRESS=1 STARPU_LIMIT_BANDWIDTH=350 STARPU_GENERATE_TRACE=1 STARPU_LIMIT_CUDA_MEM=500 STARPU_NCPU=0 STARPU_NCUDA=1 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/cholesky/cholesky_implicit -size $((960*i)) -nblocks $((i))
