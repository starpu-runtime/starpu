...
if [ $DOSSIER = "Matrice_ligne" ]
	...
	python3 /home/gonthier/these_gonthier_maxime/Code/visualisation2D.py ${N} ${ORDO} ${NGPU} 1 ${DOSSIER}
fi
if [ $DOSSIER = "MatriceZ4" ]
	...
	python3 /home/gonthier/these_gonthier_maxime/Code/visualisation2D.py ${N} ${ORDO} ${NGPU} 4$ {DOSSIER}
fi
if [ $DOSSIER = "Matrice3D" ]
	...
	python3 /home/gonthier/these_gonthier_maxime/Code/visualisation2D.py ${N} ${ORDO} ${NGPU} ${N} ${DOSSIER}
fi
if [ $DOSSIER = "Cholesky" ]
	then
