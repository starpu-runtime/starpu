...
if [ $DOSSIER = "Matrice_ligne" ]
	...
	python3 /home/gonthier/these_gonthier_maxime/Code/visualisation2D.py ${N} ${ORDO} ${NGPU} 1
fi
if [ $DOSSIER = "MatriceZ4" ]
	...
	python3 /home/gonthier/these_gonthier_maxime/Code/visualisation2D.py ${N} ${ORDO} ${NGPU} 4
fi
if [ $DOSSIER = "Matrice3D" ]
	...
	python3 /home/gonthier/these_gonthier_maxime/Code/visualisation2D.py ${N} ${ORDO} ${NGPU} ${N}
fi
if [ $DOSSIER = "Cholesky" ]
	then
