...
#### Multi GPU ####
i=10 ; STARPU_NTASKS_THRESHOLD=30 PRINTF=1 MULTIGPU=2 STARPU_WORKER_STATS=1 STARPU_BUS_STATS=1 STARPU_GENERATE_TRACE=0 STARPU_CUDA_PIPELINE=4 STARPU_SCHED=HFP STARPU_TASK_PROGRESS=0 BELADY=0 ORDER_U=1 STARPU_LIMIT_BANDWIDTH=1050 STARPU_LIMIT_CUDA_MEM=250 STARPU_NCPU=0 STARPU_NCUDA=3 STARPU_NOPENCL=0 STARPU_HOSTNAME=attila ./examples/mult/sgemm -3d -xy $((960*i)) -nblocks $((i)) -nblocksz $((4)) -iter 1
