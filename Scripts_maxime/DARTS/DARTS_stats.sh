# bash Scripts_maxime/DARTS/DARTS_stats.sh /home/gonthier/ /home/gonthier/these_gonthier_maxime/Starpu/ 2 Cholesky_dependances DARTS_stats gemini-1-fgcs 1
...
echo "N,Return NULL, Return task, Return NULL because main task list is empty,Nb of random selection,Nb 1 from free task not found after choosing a data" > Output_maxime/Data/DARTS/Choice_during_scheduling.csv
...
echo "N,selector,evicted,belady,schedule,choose_best_data,fill_planned_task_list,initialisation,randomize,pick_random_task,least_used_data_planned_task,createtolasttaskfinished" > Output_maxime/Data/DARTS/DARTS_time.csv
