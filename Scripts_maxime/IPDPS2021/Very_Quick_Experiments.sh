...
bash Scripts_maxime/PlaFRIM-Grid5k/IPDPS.sh 2 Matrice_ligne dynamic_data_aware_no_hfp_ipdps 2
...
bash Scripts_maxime/PlaFRIM-Grid5k/IPDPS.sh 2 Matrice_ligne dynamic_data_aware_no_hfp_ipdps 4
mv Output_maxime/GFlops_raw_out_1.txt Output_maxime/Data/GF_DARTS_M2D_4GPU.txt
bash Scripts_maxime/PlaFRIM-Grid5k/IPDPS.sh 2 Random_task_order dynamic_data_aware_no_hfp_ipdps 2
mv Output_maxime/GFlops_raw_out_1.txt Output_maxime/Data/GF_DARTS_M2D_RANDOM_ORDER_2GPU.txt
bash Scripts_maxime/PlaFRIM-Grid5k/Rebuttal.sh 2 Cholesky dynamic_data_aware_no_hfp 4
mv Output_maxime/GFlops_raw_out_1.txt Output_maxime/Data/GF_DARTS_CHO_4GPU.txt
bash Scripts_maxime/PlaFRIM-Grid5k/Rebuttal.sh 2 Sparse dynamic_data_aware_no_hfp 4
mv Output_maxime/GFlops_raw_out_1.txt Output_maxime/Data/GF_DARTS_SPARSE_4GPU.txt
bash Scripts_maxime/PlaFRIM-Grid5k/Rebuttal.sh 2 Sparse_mem_infinite dynamic_data_aware_no_hfp 4
