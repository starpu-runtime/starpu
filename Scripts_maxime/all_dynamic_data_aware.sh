...
echo "CHO 2 GPU"
bash Scripts_maxime/dynamic_data_aware.sh /home/gonthier/ /home/gonthier/these_gonthier_maxime/Starpu/ 6 Cholesky dynamic_data_aware_no_hfp gemini-1-fgcs 2
#~ echo "NO MEM LIMIT"
