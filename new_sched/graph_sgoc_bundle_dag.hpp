...
void graph_sched_register_task_accesses_op(graph_sched_data *data, size_t op_idx, struct starpu_task *task, GraphOp &op);
...
void graph_sched_graph_op_set_stage_from_sched_ctx(GraphOp &op, unsigned task_sched_ctx_id, struct starpu_task *);
...
void graph_op_add_writer_or_invalidate_dependencies_sgoc(graph_sched_data *data, GraphOp *consumer, size_t access_idx);
void graph_op_add_pure_read_dependencies(graph_sched_data *data, size_t consumer_op_idx, size_t access_idx);
void graph_op_add_writer_or_invalidate_dependencies(graph_sched_data *data, size_t consumer_op_idx, size_t access_idx);
